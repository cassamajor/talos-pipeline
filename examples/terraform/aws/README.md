...
| <a name="module_vmimport_role"></a> [vmimport\_role](#module\_vmimport\_role) | ./vmimport-role-module | n/a |
...
| <a name="input_s3_bucket_arn"></a> [s3\_bucket\_arn](#input\_s3\_bucket\_arn) | ARN of the S3 bucket used for VM import | `string` | `"arn:aws:s3:::talos-aws-example"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_vmimport_role_arn"></a> [vmimport\_role\_arn](#output\_vmimport\_role\_arn) | The ARN of the VMimport role. |
<!-- END_TF_DOCS -->